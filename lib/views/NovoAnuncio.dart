...
class _NovoAnuncioState extends State<NovoAnuncio> {
  ...
  _salvarAnuncio()async{
    ...
    db.collection("meus_anuncios").document(idUsuarioLogado).collection("anuncios")
        .document(_anuncio.id).setData(_anuncio.toMap()).then((_){
          
          db.collection("anuncios").document(_anuncio.id)
  ...
  Future _uploadImagens()async{
    ...
    for(var imagem in _listaImagens){
      ...
      StorageReference arquivo = pastaRaiz.child("meus_anuncios").child(_anuncio.id)
          .child(nomeImagem);
